...
class EditingModeWidget extends StatefulWidget {
  const EditingModeWidget({
    super.key,
...
class _EditingModeWidgetState extends State<EditingModeWidget> {
  late EditingModeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditingModeModel());
